...
6. The *Transform* component preprocesses the data and generates the preprocessing graph. 
7. The *Trainer* starts a AI Platform Training job. The AI Platform Training job is configured to use a custom training container. The AI Platform Training configuration, which includes the URI of the custom training image, is a compile time setting. 
