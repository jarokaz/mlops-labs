...
3. The *SchemaGen* component autogenerates a schema . This is done for tracking. The schema imported by the *ImporterNode* will be used by downstream components. 
